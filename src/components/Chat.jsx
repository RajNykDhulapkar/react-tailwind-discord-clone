...
const Chat = () => {
    ...
    return (
        <div className='flex flex-col h-screen'>
            ...
            <div className='flex items-center p-2 bg-[#40444b] mx-5 mb-7 rounded-lg'>
                ...
                <form className='flex-grow'>
                    <input
                        ...
                        className='bg-transparent text-[#dcddde] focus:outline-none w-full
                        text-sm placeholder:text-[#72767d]'
                        ref={inputRef}
                    />
