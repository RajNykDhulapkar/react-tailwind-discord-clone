...
import heroImgSvgSm from "../assets/hero-img-sm.svg";
import heroImgSvgLg from "../assets/hero-img-lg.svg";

const Hero = () => {
    return (
        <div className='bg-discord_blue pb-8 md:pb-0'>
            <div className='p-7 py-9 h-screen md:h-[83vh] md:flex relative'>
                <div className='flex flex-col gap-7 md:max-w-medium lg:max-w-none lg:justify-center'>
                    ...
                    lg:flex-row md:items-start sm:items-center gap-6'
                    >
                        <button
                            className='bg-white w-60 font-medium flex items-center justify-center 
                        rounded-full p-4 text-lg hover:shadow-2xl hover:text-discord_blurple 
                ...
                <div className='flex-grow'>
                    <img
                        src={heroImgSvgSm}
                        alt=''
                        className='absolute -left-36 mt-16 sm:-left-44
                        md:hidden'
                    />
                    <img src={heroImgSvgLg} className=' absolute hidden md:inline' alt='' />
                </div>
            </div>
        </div>
    );
